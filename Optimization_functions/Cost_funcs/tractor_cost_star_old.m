function [f,zsim] = tractor_cost_star_old(U,z0,zf,Ts,Q,Qf,Qdot,R,vsat,deltasat,asat,alpha,beta,parameters)
...
for ind=2:N+1
    % Update the state
    [zdot] = tractor_model(ztemp,U((ind-1)*2-1,1),U((ind-1)*2,1),parameters);
    ztemp                               =   ztemp+Ts*zdot;
