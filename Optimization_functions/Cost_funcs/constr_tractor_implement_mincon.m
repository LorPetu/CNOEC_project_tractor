function [h, g] = constr_tractor_implement_mincon(U,z0,parameters,Optimization_opt, constr_param)
...
n_mode = size(z0, 1);               % number of states according to the initial states input vector
